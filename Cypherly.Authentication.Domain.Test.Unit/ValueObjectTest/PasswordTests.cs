...
public class PasswordTests
{
        ...
        public void GivenInvalidPassword_Should_ReturnFailureResult(string plainPassword)
        {
            ...
            result.Error.Message.Should().Be("Incorrect password: Must be between 8 and 18 characters, contain one uppercase letter, one lowercase letter, one special character, and no spaces.");
        }
