...
public class LoginCommandHandlerTest
{
    ...
    public LoginCommandHandlerTest()
    {
        ...
        _sut = new LoginCommandHandler(_fakeRepo, _fakeJwtService, _fakeUserService, _fakeUnitOfWork, _fakeLogger);
    }
    [Fact]
    public async Task Handle_Command_When_Valid_Returns_Ok()
    {
        ...
        A.CallTo(()=>_fakeUserService.GenerateRefreshToken(user)).Returns(new RefreshToken(Guid.NewGuid(),user.Id));
