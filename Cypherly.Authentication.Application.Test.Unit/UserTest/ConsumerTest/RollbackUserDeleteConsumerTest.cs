...
public class RollbackUserDeleteConsumerTest
{
    ...
    private readonly IUserLifeCycleService _fakeLifeCycleService;
    ...
    public RollbackUserDeleteConsumerTest()
    {
        ...
        _fakeLifeCycleService = A.Fake<IUserLifeCycleService>();
        _fakeUnitOfWork = A.Fake<IUnitOfWork>();
        _fakeLogger = A.Fake<ILogger<RollbackUserDeleteConsumer>>();
        _sut = new RollbackUserDeleteConsumer(_fakeRepo, _fakeLifeCycleService, _fakeUnitOfWork, _fakeLogger);
    }
    ...
    public async Task Consume_Message_With_Invalid_ServiceType_Should_Do_Nothing()
    {
        ...
        A.CallTo(() => _fakeLifeCycleService.RevertSoftDelete(A<User>._)).MustNotHaveHappened();
    }
